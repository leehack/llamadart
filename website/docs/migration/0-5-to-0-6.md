...
sidebar_label: 0.5 to 0.6
description: "Breaking changes from llamadart 0.5.x to 0.6.x: removed template routing APIs and changed error behavior, with migration tasks."
---
