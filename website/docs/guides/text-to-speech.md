...
- The chat example pins `v0.1.47`, which retains the `v0.1.34` worker
  ...
  propagate unchanged. See the [bridge recovery contract](https://github.com/leehack/llama-web-bridge/blob/64ba8250871bf2472cc2064c6a00fff050783f02/docs/api.md#synthesizespeechoptions).
