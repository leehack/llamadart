...
// Exact affected model template; provenance is in fixtures/qwen35_schema_upstream.md.
...
List<LlamaChatMessage> qwenResultHistory() => [
  ...
  LlamaChatMessage.withContent(
    ...
    content: [
      LlamaToolResultContent(
        id: 'call_0',
        name: 'inspect',
        result: jsonEncode(qwenResultPayload),
      ),
    ],
  ),
  const LlamaChatMessage.fromText(
...
LlamaChatTemplateResult renderQwenResultHistory({
  ...
  bool thinking = true,
  String templateSource = qwenSchemaRoutingTemplate,
}) => ChatTemplateEngine.render(
  templateSource: templateSource,
  messages: qwenResultHistory(),
  metadata: const {},
...
// Synthetic Qwen routing fixture for browser-compatible parser tests. Exact
// model-template checks use qwenResultTemplatePath from VM integration/E2E.
const qwenSchemaRoutingTemplate =
    '{# <tool_call> <function= <parameter= <function> <parameters> #}'
