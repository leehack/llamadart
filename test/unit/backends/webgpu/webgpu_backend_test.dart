  ...
  group('WebGpuLlamaBackend Unit', () {
    ...
    void recordLoadConfig(JSObject? config) {
      ...
      if (nCtx.isA<JSNumber>()) {
        lastRequestedContextSize = (nCtx as JSNumber).toDartInt;
        requestedContextSizes.add(lastRequestedContextSize!);
      }
