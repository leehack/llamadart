...
external int _ggml_backend_dev_type(ggml_backend_dev_t device);
...
ggml_status ggml_backend_graph_plan_compute(
  ...
  return ggml_status.fromValue(_ggml_backend_graph_plan_compute(backend, plan));
}
...
ggml_status ggml_backend_sched_graph_compute(
  ...
  return ggml_status.fromValue(_ggml_backend_sched_graph_compute(sched, graph));
}
...
>()
external ffi.Pointer<ggml_tensor> ggml_col2im_1d(
  ffi.Pointer<ggml_context> ctx,
  ffi.Pointer<ggml_tensor> a,
  int s0,
  int oc,
...
ffi.Pointer<ggml_tensor> ggml_im2col(
  ...
  return _ggml_im2col(ctx, a, b, s0, s1, p0, p1, d0, d1, is_2D, dst_type.value);
}
...
>()
external ffi.Pointer<ggml_tensor> ggml_lightning_indexer(
  ffi.Pointer<ggml_context> ctx,
  ffi.Pointer<ggml_tensor> q,
  ffi.Pointer<ggml_tensor> k,
  ffi.Pointer<ggml_tensor> weights,
...
>()
external ffi.Pointer<llama_dart_mtp> llama_dart_mtp_init_with_draft_model(
...
llama_dart_tts_status llama_dart_tts_get_info(
  ...
  return llama_dart_tts_status.fromValue(
    _llama_dart_tts_get_info(mtmd, out_info),
  );
}
...
llama_dart_tts_status llama_dart_tts_start(
  ...
  return llama_dart_tts_status.fromValue(_llama_dart_tts_start(tts, request));
}
...
llama_dart_tts_status llama_dart_tts_step(
  ...
  return llama_dart_tts_status.fromValue(
    _llama_dart_tts_step(tts, out_progress),
  );
}
...
external int _llama_pooling_type(ffi.Pointer<llama_context> ctx);
...
external int _llama_vocab_type(ffi.Pointer<llama_vocab> vocab);
...
final class llama_context_params extends ffi.Struct {
  ...
  static ffi.Pointer<llama_context_params> $allocate(
    ...
    required int n_outputs_max_per_seq,
    ...
    ..ref.n_outputs_max_per_seq = n_outputs_max_per_seq
...
final class llama_dart_speculative_params extends ffi.Struct {
  ...
  static ffi.Pointer<llama_dart_speculative_params> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<ffi.Char> type_names,
    required int type_mask,
    required int draft_token_max,
    required int draft_token_min,
    required double draft_min_probability,
    required double draft_split_probability,
    required bool backend_sampling,
    required int ngram_size_n,
    required int ngram_size_m,
    required int ngram_min_hits,
    required int ngram_match,
    required int ngram_token_min,
    required int ngram_token_max,
    required ffi.Pointer<ffi.Char> ngram_cache_static_path,
    required ffi.Pointer<ffi.Char> ngram_cache_dynamic_path,
  }) => $allocator<llama_dart_speculative_params>()
    ..ref.type_names = type_names
    ..ref.type_mask = type_mask
    ..ref.draft_token_max = draft_token_max
    ..ref.draft_token_min = draft_token_min
    ..ref.draft_min_probability = draft_min_probability
    ..ref.draft_split_probability = draft_split_probability
    ..ref.backend_sampling = backend_sampling
    ..ref.ngram_size_n = ngram_size_n
    ..ref.ngram_size_m = ngram_size_m
    ..ref.ngram_min_hits = ngram_min_hits
    ..ref.ngram_match = ngram_match
    ..ref.ngram_token_min = ngram_token_min
    ..ref.ngram_token_max = ngram_token_max
    ..ref.ngram_cache_static_path = ngram_cache_static_path
...
final class llama_dart_tts_info extends ffi.Struct {
  ...
  static ffi.Pointer<llama_dart_tts_info> $allocate(
    ffi.Allocator $allocator, {
    required int struct_size,
    required int api_version,
    required int model_type,
    required int capabilities,
    required int sample_rate,
    required int channels,
  }) => $allocator<llama_dart_tts_info>()
    ..ref.struct_size = struct_size
    ..ref.api_version = api_version
    ..ref.model_type = model_type
...
final class llama_dart_tts_output_info extends ffi.Struct {
  ...
  static ffi.Pointer<llama_dart_tts_output_info> $allocate(
    ffi.Allocator $allocator, {
    required int struct_size,
    required int sample_rate,
    required int channels,
    required int sample_count,
  }) => $allocator<llama_dart_tts_output_info>()
    ..ref.struct_size = struct_size
    ..ref.sample_rate = sample_rate
    ..ref.channels = channels
...
final class llama_dart_tts_progress extends ffi.Struct {
  ...
  static ffi.Pointer<llama_dart_tts_progress> $allocate(
    ffi.Allocator $allocator, {
    required int struct_size,
    required int state,
    required int prompt_tokens_remaining,
    required int frames_generated,
    required bool truncated,
  }) => $allocator<llama_dart_tts_progress>()
    ..ref.struct_size = struct_size
    ..ref.state = state
    ..ref.prompt_tokens_remaining = prompt_tokens_remaining
    ..ref.frames_generated = frames_generated
...
final class llama_dart_tts_request extends ffi.Struct {
  ...
  static ffi.Pointer<llama_dart_tts_request> $allocate(
    ffi.Allocator $allocator, {
    required int struct_size,
    required ffi.Pointer<ffi.Char> text,
    required int text_length,
    required ffi.Pointer<ffi.UnsignedChar> speaker_audio,
    required int speaker_audio_length,
    required ffi.Pointer<ffi.Char> language,
    required int sequence_id,
    required int prompt_batch_size,
    required int max_frames,
    required int top_k,
    required double top_p,
    required double min_p,
    required double temperature,
    required int seed,
  }) => $allocator<llama_dart_tts_request>()
    ..ref.struct_size = struct_size
    ..ref.text = text
    ..ref.text_length = text_length
    ..ref.speaker_audio = speaker_audio
    ..ref.speaker_audio_length = speaker_audio_length
    ..ref.language = language
    ..ref.sequence_id = sequence_id
    ..ref.prompt_batch_size = prompt_batch_size
...
final class llama_sampler_i extends ffi.Struct {
  ...
  static ffi.Pointer<llama_sampler_i> $allocate(
    ...
    ..ref.backend_reset = backend_reset
    ..ref.copy_state = copy_state;
}
...
final class mtmd_context_params extends ffi.Struct {
  ...
  static ffi.Pointer<mtmd_context_params> $allocate(
    ...
    required ggml_backend_dev_t device,
...
final class mtmd_gen_audio_info extends ffi.Struct {
  ...
  set type(mtmd_gen_audio_type value) => typeAsInt = value.value;
  ...
  static ffi.Pointer<mtmd_gen_audio_info> $allocate(
    ffi.Allocator $allocator, {
    required mtmd_gen_audio_type type,
    required int sample_rate,
    required ffi.Pointer<ffi.Char> model_variant,
  }) => $allocator<mtmd_gen_audio_info>()
    ..ref.type = type
    ..ref.sample_rate = sample_rate
...
final class mtmd_gen_inp extends ffi.Struct {
  ...
  set type(mtmd_gen_process_type value) => typeAsInt = value.value;
  ...
  static ffi.Pointer<mtmd_gen_inp> $allocate(
    ffi.Allocator $allocator, {
    required mtmd_gen_process_type type,
    required int code0,
    required ffi.Pointer<ffi.Float> embd,
    required int top_k,
    required double top_p,
    ...
    required ffi.Pointer<ffi.Int32> codes,
    required int n_codes,
    required ffi.Pointer<ffi.Float> feats,
    required int n_feats,
    required ffi.Pointer<ffi.Char> state_data,
    required int state_size,
  }) => $allocator<mtmd_gen_inp>()
    ..ref.type = type
    ..ref.code0 = code0
    ..ref.embd = embd
    ..ref.top_k = top_k
    ...
    ..ref.feats = feats
    ..ref.n_feats = n_feats
    ..ref.state_data = state_data
    ..ref.state_size = state_size;
}
...
final class mtmd_gen_out extends ffi.Struct {
  ...
  static ffi.Pointer<mtmd_gen_out> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<ffi.Int32> codes,
    required int n_codes,
    required ffi.Pointer<ffi.Float> feats,
    required int n_feats,
    required ffi.Pointer<ffi.Float> embd,
    required bool is_eos,
    required ffi.Pointer<ffi.Float> audio,
    required int n_samples,
    required ffi.Pointer<ffi.Char> state_data,
    required int state_size,
  }) => $allocator<mtmd_gen_out>()
    ..ref.codes = codes
    ..ref.n_codes = n_codes
    ..ref.feats = feats
    ..ref.n_feats = n_feats
...
final class mtmd_helper_gen_audio_inp extends ffi.Struct {
  ...
  set out_type(mtmd_helper_gen_audio_outtype value) =>
      out_typeAsInt = value.value;

  static ffi.Pointer<mtmd_helper_gen_audio_inp> $allocate(
    ffi.Allocator $allocator, {
    required int seq_id,
    required ffi.Pointer<ffi.Char> prompt,
    required int prompt_len,
    required ffi.Pointer<mtmd_bitmap> speaker_ref,
    required ffi.Pointer<ffi.Char> lang,
    required int top_k,
    required double top_p,
    required int seed,
    required mtmd_helper_gen_audio_outtype out_type,
  }) => $allocator<mtmd_helper_gen_audio_inp>()
    ..ref.seq_id = seq_id
    ..ref.prompt = prompt
    ..ref.prompt_len = prompt_len
    ..ref.speaker_ref = speaker_ref
    ..ref.lang = lang
    ..ref.top_k = top_k
    ..ref.top_p = top_p
    ..ref.seed = seed
    ..ref.out_type = out_type;
}
